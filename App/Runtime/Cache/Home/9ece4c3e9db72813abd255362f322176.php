    ...
    <div class="wrapper">
        <div class="service_box">
            <div id="service_bg" class="bgs">
                <div class="current"><div style="background-image:url(/caiyang/Public/Home/caiyang/images/service.jpg)"></div></div>
                <div><div style="background-image:url(/caiyang/Public/Home/caiyang/images/service2.jpg)"></div></div>
                <div><div style="background-image:url(/caiyang/Public/Home/caiyang/images/service3.jpg)"></div></div>
            </div>
