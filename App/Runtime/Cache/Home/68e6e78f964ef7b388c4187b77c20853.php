                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-6">
                      <div class="infos">
                            ...
                            <a href="http://192.168.0.149/caiyang//index.php?s=/List/index/cid/14.html" class="about_btn"><span>立即与我们联系</span></a>
                        </div>
                  </div>
                </div>
            </div>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="brands col-xs-12 col-sm-9 col-md-9">
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo01.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo02.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo03.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo04.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo05.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo06.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo07.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo08.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo09.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo010.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo11.png" alt=""></div></div>
                        <div class="brand col-xs-4 col-sm-4 col-md-3"><div><img src="/caiyang/Public/Home/caiyang/images/logo12.png" alt=""></div></div>
                    </div>
                </div>
            </div>
			-->
