...
<link href="/caiyang/Public/Home/caiyang/css/index.css" rel="stylesheet">
 ...
 $_typeid = 5; $_keyword = ""; if($_typeid == -1) $_typeid = I('cid', 0, 'intval'); if ($_typeid>0 || substr($_typeid,0,1) == '$') { $_selfcate = Common\Lib\Category::getSelf(get_category(), $_typeid); $_tablename = strtolower($_selfcate['tablename']); $ids = Common\Lib\Category::getChildsId(get_category(), $_typeid, true); $where = array($_tablename.'.status' => 0, $_tablename .'.cid'=> array('IN',$ids)); }else { $_tablename = 'article'; $where = array($_tablename.'.status' => 0); } if ($_keyword != '') { $where[$_tablename.'.title'] = array('like','%'.$_keyword.'%'); } if (0 > 0) { $where['_string'] = $_tablename.'.flag & 0 = 0 '; } if (!empty($_tablename) && $_tablename != 'page') { if (0 > 0) { $count = D2('ArcView',"$_tablename")->where($where)->count(); $ename = I('e', '', 'htmlspecialchars,trim'); if (!empty($ename) && C('URL_ROUTER_ON') == true) { $param['p'] = I('p', 1, 'intval'); $param_action = '/'.$ename; }else { $param = array(); $param_action = ''; } $thisPage = new \Common\Lib\Page($count, 0, $param, $param_action); $thisPage->rollPage = 5; $thisPage->setConfig('theme'," %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END%"); $limit = $thisPage->firstRow. ',' .$thisPage->listRows; $page = $thisPage->show(); }else { $limit = "12"; } $_list = D2('ArcView',"$_tablename")->nofield('content,pictureurls')->where($where)->order("id DESC")->limit($limit)->select(); if (empty($_list)) { $_list = array(); } }else { $_list = array(); } foreach($_list as $autoindex => $list): $_jumpflag = ($list['flag'] & B_JUMP) == B_JUMP? true : false; $list['url'] = get_content_url($list['id'], $list['cid'], $list['ename'], $_jumpflag, $list['jumpurl']); if(30) $list['title'] = str2sub($list['title'], 30, 0); if(0) $list['description'] = str2sub($list['description'], 0, 0); if(isset($list['pictureurls'])) $list['pictureurls'] = get_picture_array($list['pictureurls']); $arr[]=$list; $json="data-json='"; $json.='{"data":['; foreach($arr as $val){ $json.='{"url":"'.$val['url'].'","img":"'.$val['litpic'].'","type":"'.$val['catename'].'","name":"'.$val['title'].'"},'; } $json.="]}'"; endforeach;?>
								   ...
								   -->
								    ...
								    <div id="case_slide" data-json='{"data":[
                                         {"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case1.jpg","type":"APP推广服务案例","name":"BOSS直聘"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case2.jpg","type":"APP推广服务案例","name":"汽车头条"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case3.jpg","type":"APP推广服务案例","name":"1元夺宝"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case4.jpg","type":"APP推广服务案例","name":"不思议迷宫"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case5.jpg","type":"APP推广服务案例","name":"机械迷城"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case6.jpg","type":"APP推广服务案例","name":"学车宝典"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case7.jpg","type":"APP推广服务案例","name":"随手记"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case8.jpg","type":"APP推广服务案例","name":"纪念碑谷"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case9.jpg","type":"APP推广服务案例","name":"WIFI管家"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case10.jpg","type":"APP推广服务案例","name":"荒岛求生"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case11.jpg","type":"APP推广服务案例","name":"壁纸多多"}
                                        ,{"url":"index.php?s=/List/index/cid/5.html","img":"/caiyang/Public/Home/caiyang/images/case12.jpg","type":"APP推广服务案例","name":"扫描全能王"}
                                    ]}'>
                                    </div>
                    ...
                    <div class="index_box item_box">
                        ...
                        <div class="container">
                            <div class="custom_box item_bd">
                                <div class="clearfix">
                                    <div class="item"><div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo1.png" alt="海信集团"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo2.png" alt="中国中化"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo3.png" alt="青岛郑建集团"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo4.png" alt="国家电网青岛公司"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo5.png" alt="青岛承建地产 青岛印象"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo6.png" alt="青岛泰凯英"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo7.png" alt="青岛宝龙地产"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo8.png" alt="青岛亨达集团"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo9.png" alt="青岛市图书馆"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo10.png"  alt="青岛市博物馆"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo10.png" alt="青岛力图数字科技网站客户"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo10.png" alt="青岛力图数字科技网站客户"></div></div><div class="item">
                                    <div><span></span><img src="/caiyang/Public/Home/caiyang/images/logo10.png" alt="青岛力图数字科技网站客户"></div></div>
                                    <div class="city"></div>
 ...
 $block = get_block("email"); $block_content = ''; if ($block) { if ($block['blocktype'] == 2) { if (!0) { $block_content = '<img src="'. $block['content'] .'" />'; }else { $block_content = $block['content']; } }else { if(0) { $block_content = str2sub(strip_tags($block['content']), 0, 0); }else { $block_content = $block['content']; } } } echo $block_content; ?></span></a>        </div>
    ...
    <script src="/caiyang/Public/Home/caiyang/js/index.js"></script>